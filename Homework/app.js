...
data.recipes.forEach(recipe => {
  ...
  card.innerHTML = `
    ...
    <div style="text-align:center; padding:10px;">
      <button onclick="showPopup()" style="padding:10px 15px; background-color:#a74128; color:white; border:none; border-radius:8px; font-weight:bold; cursor:pointer;">
        👥 ${recipe.servings} Servings - Order It Now
      </button>
    </div>

    <div class="info-row">
      
      <div class="rating-box">⭐ ${recipe.rating}</div>
      <div class="cuisine-box">${recipe.cuisine}</div>
    </div>
  `;
